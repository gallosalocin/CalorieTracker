...
fun GenderScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = "What is your gender?"/* stringResource(id = R.string.whats_your_gender) */,
                style = MaterialTheme.typography.h3
            )
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            Row {
                SelectableButton(
                    text = "Male"/* stringResource(id = R.string.male) */,
                ...
                SelectableButton(
                    text = "Female"/* stringResource(id = R.string.female) */,
